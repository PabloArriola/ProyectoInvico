...
<head>
	...
	<script src="http://cdn.datatables.net/1.10.23/css/jquery.dataTables.min.css"></script>
        ...
        <title>Invico</title>
    <div class="header">
        <div style="width: 107px;position:relative;top:1px">
            <img class="img-responsive" position="right" style="width:90px;hidden:90px" alt="Chania" src="https://www.invico.gov.ar/Content/imagenes/INVICO-logo.svg">
        </div>
    ...
    <title>Instituto de Viviendas de Corrientes</title>
</head>
<body>
